...
urlpatterns = [
    ...
    path('category/', views.category_redirect, name='categories'),
    ...
    path('writeup/create', views.WriteupCreateView.as_view(), name='writeup_create'),
    path('writeup/<int:pk>/edit', views.WriteupEditView.as_view(), name='writeup-edit'),
    path('writeup/<int:pk>/delete', views.WriteupDeleteView.as_view(), name='writeup-delete'),
